...
| [Stateless DeleGator from MetaMask](https://github.com/MetaMask/delegation-framework) | [ERC-7710](https://eips.ethereum.org/EIPS/eip-7710), [ERC-4337](https://eips.ethereum.org/EIPS/eip-4337) | A smart account used in MetaMask wallet, supporting multiple execution modes, gas sponsorship, and delegation. |
